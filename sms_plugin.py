...
# All runtime data lives under one plugin folder. Suffixed "-beta" so this variant
# never shares data with a simultaneously-installed stable version.
PLUGIN_DATA_DIR = "/home/fpp/media/plugin.fpp-sms-twilio-beta"
...
if __name__ == '__main__':
    ...
    logging.info("FPP SMS Plugin v2.5 (beta) starting...")
    # Port 5001 (not 5000) so this beta instance can run alongside a stable install.
